"""
Django settings for gestor-de-consultas project.
...
ROOT_URLCONF = 'gestor-de-consultas.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'gestor-de-consultas', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'gestor-de-consultas.wsgi.application'
